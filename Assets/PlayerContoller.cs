...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/PlayerContoller.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerContoller: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerContoller()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerContoller.Player.Disable() has not been called.");
    }

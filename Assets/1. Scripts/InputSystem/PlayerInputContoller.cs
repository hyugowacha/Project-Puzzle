...
//     version 1.17.0
//     from Assets/PlayerInputContoller.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/PlayerInputContoller.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @PlayerInputContoller: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""5a8c5564-7be0-4eb8-ad58-271371c58a5f"",
            ""actions"": [
                {
                    ""name"": ""TouchPosition"",
                    ""type"": ""Value"",
                    ""id"": ""d3f3893b-2d5f-40e5-859e-11ad5de31db4"",
                ...
                },
                {
                    ""name"": ""TouchPress"",
                    ""type"": ""Button"",
                    ""id"": ""8fcc6142-08f9-4a94-a39d-3af94be5908c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a3def0a1-93af-4e08-bedc-a9b40bcdf4b0"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""283ccc53-415c-4e97-83d1-3458baa5fa02"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0aa632bd-5af0-49da-a6cb-9e0d24c2c5c9"",
                ...
                {
                    ""name"": """",
                    ""id"": ""b4a1e364-ba94-4900-b227-d089a62c6925"",
    ...
    ~@PlayerInputContoller()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerInputContoller.Player.Disable() has not been called.");
    }
